...
namespace IngameScript
{
    partial class Program : MyGridProgram
    {
        ...
        void MArmOS_Configuration()
        {
            ...
            var Prefix = "GenericArm5: ";

            var S0 = new SolidSG(0, 0, 0);

            var R1 = new Rotor(Name: Prefix + "Motor1", Axis: "Z", OriMode: 0);
            var S1 = new SolidSG(2, 0, 4);

            var R2_1 = new Rotor(Name: Prefix + "Hinge2_1", Axis: "-Y", OriMode: 0, Home: 90);
            var R2_2 = new Rotor(Name: Prefix + "Hinge2_2", Axis: "-Y", OriMode: 0, Home: 90);
            var P3_1 = new Piston(Name: Prefix + "Piston3_1", Axis: "Z");
            var P3_2 = new Piston(Name: Prefix + "Piston3_2", Axis: "Z");
            var S3 = new SolidSG(1, 0, 4);

            var R4 = new Rotor(Name: Prefix + "Hinge4", Axis: "-Y", OriMode: 0, Home: -90);
            var S4 = new SolidSG(5, 0, 0);

            var R5 = new Rotor(Name: Prefix + "Motor5", Axis: "X", OriMode: 1);
            var P6 = new Piston(Name: Prefix + "Piston6", Axis: "X");
            var S6 = new SolidSG(0, 0, -1);

            var R7 = new Rotor(Name: Prefix + "Hinge7", Axis: "-Y", OriMode: 1);
            var S7 = new SolidSG(0, 0, -2);

            var R8 = new Rotor(Name: Prefix + "Motor8", Axis: "-Z", OriMode: 1);

            DefaultArm = S0 + R1 + S1 + R2_1 * R2_2 + P3_1 * P3_2 + S3 + R4 + S4 + R5 + P6 + S6 + R7 + S7 + R8;


            DefaultShipControllerKeyword = Prefix + "Arm Controller";
            DefaultSpeed = 2;
            DefaultSoftness = 6;

            // DefaultUseArmAsReference = true;  // <-- Uncomment to control relatively to the tip of the arm.
        ...
        static double HomeSpeedPropagation = 1.1;  // Hardware on the tip goes faster.
