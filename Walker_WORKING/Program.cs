...
namespace IngameScript
{
    partial class Program : MyGridProgram
    {
        ...
        class Toggle : Option
        {
            ...
            public Toggle(Program prog, string name, string describe, bool init, ToggleUpdate update = null) : base(prog, name, describe)
            {
                State = init;
                OptionUpdate = update;
            }
        ...
        class Setting : Option
        {
            ...
            //SettingUpdate OptionUpdate;

            public Setting(Program prog, string name, string describe, float init, float increment, float max = 1, float min = 0, Setting incr = null) : base(prog, name, describe)
            {
                Value = init;
                Increment = increment;
                ValueMax = max;
            ...
            {
                float delta = Incrementer == null ? Increment : Incrementer.Value;
        ...
        class Root
        {
            ...
            public void Load(string input, Option option = null)
            {
                StaticDlog($"Load Root String: {input}");
                Load(input.Split(':'), option);
            }
            public virtual bool Load(string[] data, Option option = null)
            {
        ...
        class Joint : Root
        {
            ...
            public override bool Load(string[] data, Option option = null)
            {
                if (!base.Load(data))
                    return false;
        ...
        class Animation : Root
        {
            ...
            public virtual void GenerateSetting(float init, Setting adjuster = null)
            {
            ...
            public override bool Load(string[] data, Option option = null)
            {
                ...
                try { GenerateSetting(float.Parse(data[4]), (Setting)option); }
                catch { GenerateSetting(0, (Setting)option); }
                return true;
            }
            public override string SaveData()
            {
        ...
        class JointFrame : Animation
        {
            ...
            public JointFrame(RootData root, Joint joint, Setting adjuster, bool snapping = true) : base(root) // Snapshot
            {
                TAG = JframeTag;
                Joint = joint;
                GenerateSetting((float)Joint.CurrentPosition(), adjuster);
                if (snapping)
                {
                    MySetting.Change((int)MySetting.MyValue());
                }
            }
            public JointFrame(Program program, Joint joint/*, Setting adjuster*/) : base(program)
            {
                StaticDlog("Jframe Constructor:");
                Joint = joint;
            }
            public override void GenerateSetting(float init, Setting adjuster = null)
            {
        ...
        class Sequence : Animation
        {
            ...
            public bool AddKeyFrameSnapshot(int index, string name = null, bool snapping = false)
            {
                ...
                for (int i = 0; i < JointSet.Joints.Count; i++)
                {
                    ...
                    newKFrame.Jframes.Add(new JointFrame(jfRoot, JointSet.GetJoint(i), Program.SnappingIncrement, snapping));
                }
    ...
    "q/e",
        ...
        const string MainText = "Mech Control v0.5.2\n\n" +
            ...
            Settings = new List<Setting>
    {
        ...
        void SetupToggles()
        {
            ...
            Orientation = new Toggle(this, "Orientation", "Enables the use to orient the mech using the controller inputs of the cockpit", true, ToggleOrientation);
            ...
            Toggles = new List<Toggle>
    {
        ...
        JointFrame LoadJointFrame(string input, Joint joint)
        {
            ...
            newJframe.Load(input, SnappingIncrement);
            return newJframe;
        }
